<template id="planet-create" @planet-submitted="createPlanet">
    <div class="form-style">
        ...
        <form class="create" @submit="checkForm" :action=`/api/planet-system/${planetSystemName}/planets/create` method="post">
          ...
          <input type="number" step="any" name="mass" id="mass" v-model="mass" min="0">

          <label for="radius">Radius<label>
          <input type="number" step="any" name="radius" id="radius" v-model="radius" min="0">

          <label for="semiMajorAxis">Semi-Major Axis<label>
          <input type="number" step="any"name="semiMajorAxis" id="semiMajorAxis" v-model="semiMajorAxis" min="0">

          <label for="eccentricity">Eccentricity<label>
          <input type="number" step="any" name="eccentricity" id="eccentricity" v-model="eccentricity" min="0" max="1">

          <label for="orbitalPeriod">Orbital Period<label>
          <input type="number" step="any" name="orbitalPeriod" id="orbitalPeriod" v-model="orbitalPeriod" min="0">
